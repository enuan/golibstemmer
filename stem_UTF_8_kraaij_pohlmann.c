...
static int r_R1(struct SN_env * z) { /* backwardmode */
    ...
    if (!(z->I[0] >= z->I[1])) return 0; /* $x >= <integer expression>, line 32 */
    return 1;
}

static int r_R2(struct SN_env * z) { /* backwardmode */
    z->I[0] = z->c; /* setmark x, line 33 */
    if (!(z->I[0] >= z->I[2])) return 0; /* $x >= <integer expression>, line 33 */
    return 1;
}
...
static int r_V(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 35 */
        {   int m2 = z->l - z->c; (void)m2; /* or, line 35 */
            if (in_grouping_b_U(z, g_v, 97, 121, 0)) goto lab1; /* grouping v, line 35 */
            goto lab0;
        lab1:
            z->c = z->l - m2;
            if (!(eq_s_b(z, 2, s_0))) return 0; /* literal, line 35 */
        }
    lab0:
        z->c = z->l - m_test1;
    }
...
static int r_VX(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 36 */
        ...
        {   int m2 = z->l - z->c; (void)m2; /* or, line 36 */
            if (in_grouping_b_U(z, g_v, 97, 121, 0)) goto lab1; /* grouping v, line 36 */
            goto lab0;
        lab1:
            z->c = z->l - m2;
            if (!(eq_s_b(z, 2, s_1))) return 0; /* literal, line 36 */
        }
    lab0:
        z->c = z->l - m_test1;
    }
...
static int r_C(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 37 */
        {   int m2 = z->l - z->c; (void)m2; /* not, line 37 */
            if (!(eq_s_b(z, 2, s_2))) goto lab0; /* literal, line 37 */
            return 0;
        lab0:
            z->c = z->l - m2;
        }
        if (out_grouping_b_U(z, g_v, 97, 121, 0)) return 0; /* non v, line 37 */
        z->c = z->l - m_test1;
    }
    return 1;
}
...
static int r_lengthen_V(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c; (void)m1; /* do, line 39 */
        if (out_grouping_b_U(z, g_v_WX, 97, 121, 0)) goto lab0; /* non v_WX, line 40 */
        z->ket = z->c; /* [, line 40 */
        {   int m2 = z->l - z->c; (void)m2; /* or, line 40 */
            if (in_grouping_b_U(z, g_AOU, 97, 117, 0)) goto lab2; /* grouping AOU, line 40 */
            z->bra = z->c; /* ], line 40 */
            {   int m_test3 = z->l - z->c; /* test, line 40 */
                {   int m4 = z->l - z->c; (void)m4; /* or, line 40 */
                    if (out_grouping_b_U(z, g_v, 97, 121, 0)) goto lab4; /* non v, line 40 */
                    goto lab3;
                lab4:
                    z->c = z->l - m4;
        ...
        lab2:
            z->c = z->l - m2;
            if (z->c <= z->lb || z->p[z->c - 1] != 'e') goto lab0; /* literal, line 41 */
            z->c--;
            z->bra = z->c; /* ], line 41 */
            {   int m_test5 = z->l - z->c; /* test, line 41 */
                {   int m6 = z->l - z->c; (void)m6; /* or, line 41 */
                    if (out_grouping_b_U(z, g_v, 97, 121, 0)) goto lab6; /* non v, line 41 */
                    goto lab5;
                lab6:
                    z->c = z->l - m6;
            ...
            lab5:
                {   int m7 = z->l - z->c; (void)m7; /* not, line 42 */
                    if (in_grouping_b_U(z, g_AIOU, 97, 117, 0)) goto lab7; /* grouping AIOU, line 42 */
                    goto lab0;
                lab7:
                    z->c = z->l - m7;
                }
                {   int m8 = z->l - z->c; (void)m8; /* not, line 43 */
                    {   int ret = skip_utf8(z->p, z->c, z->lb, 0, -1);
                        if (ret < 0) goto lab8;
                        z->c = ret; /* next, line 43 */
                    }
                    if (in_grouping_b_U(z, g_AIOU, 97, 117, 0)) goto lab8; /* grouping AIOU, line 43 */
                    if (out_grouping_b_U(z, g_v, 97, 121, 0)) goto lab8; /* non v, line 43 */
                    goto lab0;
                lab8:
                    z->c = z->l - m8;
                }
    ...
    lab1:
        ...
        {   int ret;
            {   int saved_c = z->c;
                ret = insert_v(z, z->c, z->c, z->S[0]); /* <+ ch, line 44 */
                z->c = saved_c;
            }
            if (ret < 0) return ret;
        }
...
static int r_Step_1(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 49 */
    if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((540704 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0; /* among, line 49 */
    ...
    switch (among_var) { /* among, line 49 */
        ...
        case 1:
            ...
            break;
        case 2:
            {   int ret = r_R1(z); /* call R1, line 52 */
                if (ret <= 0) return ret;
            }
            {   int m1 = z->l - z->c; (void)m1; /* not, line 52 */
                if (z->c <= z->lb || z->p[z->c - 1] != 't') goto lab0; /* literal, line 52 */
                z->c--;
                {   int ret = r_R1(z); /* call R1, line 52 */
                    if (ret == 0) goto lab0;
                    if (ret < 0) return ret;
        ...
        case 3:
            ...
            {   int ret = slice_from_s(z, 2, s_3); /* <-, line 53 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int m2 = z->l - z->c; (void)m2; /* or, line 55 */
                if (!(eq_s_b(z, 2, s_4))) goto lab2; /* literal, line 55 */
                ...
                {   int ret = r_lengthen_V(z); /* call lengthen_V, line 55 */
                    if (ret == 0) goto lab2;
                    if (ret < 0) return ret;
                }
                goto lab1;
            lab2:
                z->c = z->l - m2;
                if (!(eq_s_b(z, 2, s_5))) goto lab3; /* literal, line 56 */
                {   int ret = r_R1(z); /* call R1, line 56 */
                    if (ret == 0) goto lab3;
                    if (ret < 0) return ret;
                }
                {   int ret = r_C(z); /* call C, line 56 */
                    if (ret == 0) goto lab3;
                    if (ret < 0) return ret;
                }
                z->bra = z->c; /* ], line 56 */
        ...
        lab1:
            break;
        case 5:
            {   int ret = r_R1(z); /* call R1, line 59 */
                if (ret <= 0) return ret;
            }
            {   int ret = r_V(z); /* call V, line 59 */
                if (ret <= 0) return ret;
            }
            {   int ret = slice_from_s(z, 2, s_7); /* <-, line 59 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int m3 = z->l - z->c; (void)m3; /* or, line 60 */
                if (!(eq_s_b(z, 3, s_8))) goto lab5; /* literal, line 60 */
            ...
            lab5:
                z->c = z->l - m3;
                if (!(eq_s_b(z, 2, s_10))) goto lab6; /* literal, line 61 */
            ...
            lab6:
                z->c = z->l - m3;
                if (z->c <= z->lb || z->p[z->c - 1] != 'd') goto lab7; /* literal, line 62 */
                z->c--;
            ...
            lab7:
                ...
                {   int m4 = z->l - z->c; (void)m4; /* or, line 63 */
                    if (z->c <= z->lb || z->p[z->c - 1] != 'i') goto lab10; /* literal, line 63 */
                    z->c--;
                    goto lab9;
                lab10:
                    z->c = z->l - m4;
                    if (z->c <= z->lb || z->p[z->c - 1] != 'j') goto lab8; /* literal, line 63 */
                    z->c--;
                }
            lab9:
                {   int ret = r_V(z); /* call V, line 63 */
                    if (ret == 0) goto lab8;
                    if (ret < 0) return ret;
                }
            ...
            lab8:
                z->c = z->l - m3;
                {   int ret = r_R1(z); /* call R1, line 64 */
                    if (ret <= 0) return ret;
                }
                {   int ret = r_C(z); /* call C, line 64 */
                    if (ret <= 0) return ret;
                }
                {   int ret = slice_del(z); /* delete, line 64 */
                    if (ret < 0) return ret;
                }
                {   int ret = r_lengthen_V(z); /* call lengthen_V, line 64 */
                    if (ret <= 0) return ret;
                }
            }
        lab4:
            break;
        case 7:
            {   int ret = slice_from_s(z, 2, s_11); /* <-, line 65 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Step_2(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 71 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 101) return 0; /* among, line 71 */
    ...
    switch (among_var) { /* among, line 71 */
        ...
        case 1:
            {   int m1 = z->l - z->c; (void)m1; /* or, line 72 */
                if (!(eq_s_b(z, 2, s_12))) goto lab1; /* literal, line 72 */
                z->bra = z->c; /* ], line 72 */
            ...
            lab1:
                z->c = z->l - m1;
                if (!(eq_s_b(z, 2, s_13))) goto lab2; /* literal, line 73 */
                z->bra = z->c; /* ], line 73 */
                {   int ret = r_R1(z); /* call R1, line 73 */
                    if (ret == 0) goto lab2;
                    if (ret < 0) return ret;
                }
                {   int ret = r_C(z); /* call C, line 73 */
                    if (ret == 0) goto lab2;
                    if (ret < 0) return ret;
                }
            ...
            lab2:
                z->c = z->l - m1;
                if (!(eq_s_b(z, 3, s_14))) goto lab3; /* literal, line 74 */
                z->bra = z->c; /* ], line 74 */
                {   int ret = slice_from_s(z, 2, s_15); /* <-, line 74 */
                    if (ret < 0) return ret;
                }
                goto lab0;
            lab3:
                z->c = z->l - m1;
                if (z->c <= z->lb || z->p[z->c - 1] != 't') goto lab4; /* literal, line 75 */
                z->c--;
                z->bra = z->c; /* ], line 75 */
                {   int ret = r_R1(z); /* call R1, line 75 */
                    if (ret == 0) goto lab4;
                    if (ret < 0) return ret;
                }
                {   int ret = r_VX(z); /* call VX, line 75 */
                    if (ret == 0) goto lab4;
                    if (ret < 0) return ret;
                }
            ...
            lab4:
                z->c = z->l - m1;
                if (!(eq_s_b(z, 3, s_16))) goto lab5; /* literal, line 76 */
                z->bra = z->c; /* ], line 76 */
            ...
            lab5:
                z->c = z->l - m1;
                if (!(eq_s_b(z, 2, s_18))) goto lab6; /* literal, line 77 */
                z->bra = z->c; /* ], line 77 */
                {   int ret = slice_from_s(z, 1, s_19); /* <-, line 77 */
                    if (ret < 0) return ret;
                }
                goto lab0;
            lab6:
                z->c = z->l - m1;
                if (z->c <= z->lb || z->p[z->c - 1] != '\'') goto lab7; /* literal, line 78 */
                z->c--;
                z->bra = z->c; /* ], line 78 */
        ...
        case 2:
            ...
            {   int ret = slice_from_s(z, 1, s_20); /* <-, line 80 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            ...
            {   int ret = slice_from_s(z, 4, s_21); /* <-, line 81 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = slice_from_s(z, 4, s_22); /* <-, line 82 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
        ...
        case 6:
            ...
            {   int ret = slice_from_s(z, 1, s_23); /* <-, line 84 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            ...
            {   int ret = slice_from_s(z, 1, s_24); /* <-, line 85 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            ...
            {   int ret = slice_from_s(z, 1, s_25); /* <-, line 86 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            ...
            {   int ret;
                ret = insert_s(z, z->c, z->c, 1, s_26); /* attach, line 87 */
                if (ret < 0) return ret;
            }
            {   int ret = r_lengthen_V(z); /* call lengthen_V, line 87 */
                if (ret <= 0) return ret;
            }
            break;
        case 10:
            {   int ret = r_R1(z); /* call R1, line 88 */
                if (ret <= 0) return ret;
            }
            {   int ret = r_C(z); /* call C, line 88 */
                if (ret <= 0) return ret;
            }
            ...
            {   int ret;
                ret = insert_s(z, z->c, z->c, 2, s_27); /* attach, line 88 */
                if (ret < 0) return ret;
            }
            {   int ret = r_lengthen_V(z); /* call lengthen_V, line 88 */
                if (ret <= 0) return ret;
            }
            break;
        case 11:
            {   int ret = r_R1(z); /* call R1, line 89 */
                if (ret <= 0) return ret;
            }
            {   int ret = r_C(z); /* call C, line 89 */
                if (ret <= 0) return ret;
            }
            {   int ret = slice_from_s(z, 3, s_28); /* <-, line 89 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Step_3(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 95 */
    if (z->c - 2 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1316016 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0; /* among, line 95 */
    ...
    switch (among_var) { /* among, line 95 */
        ...
        case 1:
            ...
            {   int ret = slice_from_s(z, 3, s_29); /* <-, line 96 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = r_R1(z); /* call R1, line 97 */
                if (ret <= 0) return ret;
            }
            {   int ret = slice_del(z); /* delete, line 97 */
                if (ret < 0) return ret;
            }
            {   int ret = r_lengthen_V(z); /* call lengthen_V, line 97 */
                if (ret <= 0) return ret;
            }
            break;
        case 3:
            ...
            break;
        case 4:
            {   int ret = slice_from_s(z, 1, s_30); /* <-, line 101 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = r_R1(z); /* call R1, line 104 */
                if (ret <= 0) return ret;
            }
            ...
            break;
        case 6:
            {   int ret = r_R1(z); /* call R1, line 105 */
                if (ret <= 0) return ret;
            }
            {   int ret = r_C(z); /* call C, line 105 */
                if (ret <= 0) return ret;
            }
            {   int ret = slice_from_s(z, 3, s_31); /* <-, line 105 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            ...
            {   int ret;
                ret = insert_s(z, z->c, z->c, 1, s_32); /* attach, line 106 */
                if (ret < 0) return ret;
            }
            {   int ret = r_lengthen_V(z); /* call lengthen_V, line 106 */
                if (ret <= 0) return ret;
            }
            break;
        case 8:
            ...
            {   int ret;
                ret = insert_s(z, z->c, z->c, 1, s_33); /* attach, line 107 */
                if (ret < 0) return ret;
            }
            {   int ret = r_lengthen_V(z); /* call lengthen_V, line 107 */
                if (ret <= 0) return ret;
            }
            break;
        case 9:
            ...
            {   int ret = r_C(z); /* call C, line 108 */
                if (ret <= 0) return ret;
            }
            {   int ret = slice_from_s(z, 1, s_34); /* <-, line 108 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            ...
            {   int ret = r_C(z); /* call C, line 109 */
                if (ret <= 0) return ret;
            }
            {   int ret = slice_from_s(z, 1, s_35); /* <-, line 109 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Step_4(struct SN_env * z) { /* backwardmode */
    ...
    {   int m1 = z->l - z->c; (void)m1; /* or, line 134 */
        z->ket = z->c; /* [, line 115 */
        if (z->c - 2 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1315024 >> (z->p[z->c - 1] & 0x1f)) & 1)) goto lab1; /* among, line 115 */
        ...
        switch (among_var) { /* among, line 115 */
            ...
            case 1:
                ...
                {   int ret = slice_from_s(z, 2, s_36); /* <-, line 116 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                ...
                {   int ret = slice_from_s(z, 3, s_37); /* <-, line 117 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
            ...
            case 4:
                ...
                {   int ret = slice_from_s(z, 1, s_38); /* <-, line 119 */
                    if (ret < 0) return ret;
                }
                break;
            case 5:
                ...
                {   int ret = r_V(z); /* call V, line 120 */
                    if (ret == 0) goto lab1;
                    if (ret < 0) return ret;
                }
                {   int ret = slice_from_s(z, 1, s_39); /* <-, line 120 */
                    if (ret < 0) return ret;
                }
                break;
            case 6:
                ...
                {   int ret = r_V(z); /* call V, line 121 */
                    if (ret == 0) goto lab1;
                    if (ret < 0) return ret;
                }
                {   int ret = slice_from_s(z, 1, s_40); /* <-, line 121 */
                    if (ret < 0) return ret;
                }
                break;
            case 7:
                ...
                {   int ret = slice_from_s(z, 4, s_41); /* <-, line 122 */
                    if (ret < 0) return ret;
                }
                break;
            case 8:
                ...
                {   int ret = slice_from_s(z, 4, s_42); /* <-, line 124 */
                    if (ret < 0) return ret;
                }
                break;
            case 9:
                ...
                break;
            case 10:
                {   int ret = r_R1(z); /* call R1, line 131 */
                    if (ret == 0) goto lab1;
                    if (ret < 0) return ret;
                }
                {   int ret = r_C(z); /* call C, line 131 */
                    if (ret == 0) goto lab1;
                    if (ret < 0) return ret;
                }
                ...
                {   int ret = r_lengthen_V(z); /* call lengthen_V, line 131 */
                    if (ret == 0) goto lab1;
                    if (ret < 0) return ret;
                }
                break;
    ...
    lab1:
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 135 */
        if (z->c - 1 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1310848 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0; /* among, line 135 */
        ...
        switch (among_var) { /* among, line 135 */
            ...
            case 1:
                ...
                {   int ret = r_C(z); /* call C, line 138 */
                    if (ret <= 0) return ret;
                }
                {   int ret = slice_del(z); /* delete, line 138 */
                    if (ret < 0) return ret;
                }
                {   int ret = r_lengthen_V(z); /* call lengthen_V, line 138 */
                    if (ret <= 0) return ret;
                }
                break;
        }
...
static int r_Step_7(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 145 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 116) return 0; /* among, line 145 */
    ...
    switch (among_var) { /* among, line 145 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 1, s_43); /* <-, line 146 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(z, 1, s_44); /* <-, line 147 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(z, 1, s_45); /* <-, line 148 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Step_6(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 154 */
    if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((98532828 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0; /* among, line 154 */
    ...
    switch (among_var) { /* among, line 154 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 1, s_46); /* <-, line 155 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(z, 1, s_47); /* <-, line 156 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(z, 1, s_48); /* <-, line 157 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(z, 1, s_49); /* <-, line 158 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(z, 1, s_50); /* <-, line 159 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(z, 1, s_51); /* <-, line 160 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(z, 1, s_52); /* <-, line 161 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(z, 1, s_53); /* <-, line 162 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret = slice_from_s(z, 1, s_54); /* <-, line 163 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = slice_from_s(z, 1, s_55); /* <-, line 164 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(z, 1, s_56); /* <-, line 165 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret = slice_from_s(z, 1, s_57); /* <-, line 166 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret = slice_from_s(z, 1, s_58); /* <-, line 167 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret = slice_from_s(z, 1, s_59); /* <-, line 168 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret = slice_from_s(z, 1, s_60); /* <-, line 169 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
            {   int ret = slice_from_s(z, 1, s_61); /* <-, line 170 */
                if (ret < 0) return ret;
            }
            break;
        case 17:
            {   int ret = slice_from_s(z, 1, s_62); /* <-, line 171 */
                if (ret < 0) return ret;
            }
            break;
        case 18:
            {   int ret = slice_from_s(z, 1, s_63); /* <-, line 172 */
                if (ret < 0) return ret;
            }
            break;
        case 19:
            {   int ret = slice_from_s(z, 1, s_64); /* <-, line 173 */
                if (ret < 0) return ret;
            }
            break;
        case 20:
            {   int ret = slice_from_s(z, 1, s_65); /* <-, line 174 */
                if (ret < 0) return ret;
            }
            break;
        case 21:
            {   int ret = slice_from_s(z, 1, s_66); /* <-, line 175 */
                if (ret < 0) return ret;
            }
            break;
        case 22:
            {   int ret = slice_from_s(z, 1, s_67); /* <-, line 176 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Step_1c(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 182 */
    if (z->c <= z->lb || (z->p[z->c - 1] != 100 && z->p[z->c - 1] != 116)) return 0; /* among, line 182 */
    ...
    switch (among_var) { /* among, line 182 */
        ...
        case 1:
            {   int m1 = z->l - z->c; (void)m1; /* not, line 183 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'n') goto lab0; /* literal, line 183 */
                z->c--;
                {   int ret = r_R1(z); /* call R1, line 183 */
                    if (ret == 0) goto lab0;
                    if (ret < 0) return ret;
                }
                return 0;
        ...
        case 2:
            {   int m2 = z->l - z->c; (void)m2; /* not, line 184 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'h') goto lab1; /* literal, line 184 */
                z->c--;
                {   int ret = r_R1(z); /* call R1, line 184 */
                    if (ret == 0) goto lab1;
                    if (ret < 0) return ret;
                }
                return 0;
...
static int r_Lose_prefix(struct SN_env * z) { /* forwardmode */
    z->bra = z->c; /* [, line 190 */
    if (!(eq_s(z, 2, s_68))) return 0; /* literal, line 190 */
    z->ket = z->c; /* ], line 190 */
    {   int c_test1 = z->c; /* test, line 190 */
        {   int ret = skip_utf8(z->p, z->c, 0, z->l, + 3); /* hop, line 190 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = c_test1;
...
static int r_Lose_infix(struct SN_env * z) { /* forwardmode */
    ...
    while(1) { /* gopast, line 197 */
        z->bra = z->c; /* [, line 197 */
        if (!(eq_s(z, 2, s_69))) goto lab0; /* literal, line 197 */
        z->ket = z->c; /* ], line 197 */
        break;
    lab0:
        {   int ret = skip_utf8(z->p, z->c, 0, z->l, 1);
    ...
    {   int c_test1 = z->c; /* test, line 197 */
        {   int ret = skip_utf8(z->p, z->c, 0, z->l, + 3); /* hop, line 197 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = c_test1;
...
static int r_measure(struct SN_env * z) { /* forwardmode */
    ...
    {   int c2 = z->c; /* do, line 208 */
        while(1) { /* repeat, line 209 */
            if (out_grouping_U(z, g_v, 97, 121, 0)) goto lab2; /* non v, line 209 */
            continue;
        lab2:
            break;
        }
        {   int i = 1;
            while(1) { /* atleast, line 209 */
                ...
                {   int c4 = z->c; /* or, line 209 */
                    if (!(eq_s(z, 2, s_70))) goto lab5; /* literal, line 209 */
                    goto lab4;
                lab5:
                    z->c = c4;
                    if (in_grouping_U(z, g_v, 97, 121, 0)) goto lab3; /* grouping v, line 209 */
                }
            lab4:
                i--;
                continue;
        ...
        if (out_grouping_U(z, g_v, 97, 121, 0)) goto lab1; /* non v, line 209 */
        z->I[1] = z->c; /* setmark p1, line 209 */
        while(1) { /* repeat, line 210 */
            if (out_grouping_U(z, g_v, 97, 121, 0)) goto lab6; /* non v, line 210 */
            continue;
        lab6:
            break;
        }
        {   int i = 1;
            while(1) { /* atleast, line 210 */
                ...
                {   int c6 = z->c; /* or, line 210 */
                    if (!(eq_s(z, 2, s_71))) goto lab9; /* literal, line 210 */
                    goto lab8;
                lab9:
                    z->c = c6;
                    if (in_grouping_U(z, g_v, 97, 121, 0)) goto lab7; /* grouping v, line 210 */
                }
            lab8:
                i--;
                continue;
        ...
        if (out_grouping_U(z, g_v, 97, 121, 0)) goto lab1; /* non v, line 210 */
...
extern int kraaij_pohlmann_UTF_8_stem(struct SN_env * z) { /* forwardmode */
    ...
    {   int c1 = z->c; /* do, line 218 */
        z->bra = z->c; /* [, line 218 */
        if (z->c == z->l || z->p[z->c] != 'y') goto lab0; /* literal, line 218 */
        z->c++;
        z->ket = z->c; /* ], line 218 */
        {   int ret = slice_from_s(z, 1, s_72); /* <-, line 218 */
            if (ret < 0) return ret;
        }
    ...
    {   int c2 = z->c; /* do, line 219 */
        while(1) { /* repeat, line 219 */
            ...
            while(1) { /* goto, line 219 */
                int c4 = z->c;
                if (in_grouping_U(z, g_v, 97, 121, 0)) goto lab3; /* grouping v, line 219 */
                z->bra = z->c; /* [, line 219 */
                if (z->c == z->l || z->p[z->c] != 'y') goto lab3; /* literal, line 219 */
                z->c++;
                z->ket = z->c; /* ], line 219 */
                z->c = c4;
                break;
            ...
            {   int ret = slice_from_s(z, 1, s_73); /* <-, line 219 */
                if (ret < 0) return ret;
            }
    ...
    {   int ret = r_measure(z); /* call measure, line 221 */
        if (ret <= 0) return ret;
    }
    z->lb = z->c; z->c = z->l; /* backwards, line 223 */

    {   int m5 = z->l - z->c; (void)m5; /* do, line 224 */
        {   int ret = r_Step_1(z); /* call Step_1, line 224 */
            if (ret == 0) goto lab4;
            if (ret < 0) return ret;
        }
    ...
    {   int m6 = z->l - z->c; (void)m6; /* do, line 225 */
        {   int ret = r_Step_2(z); /* call Step_2, line 225 */
            if (ret == 0) goto lab5;
            if (ret < 0) return ret;
        }
    ...
    {   int m7 = z->l - z->c; (void)m7; /* do, line 226 */
        {   int ret = r_Step_3(z); /* call Step_3, line 226 */
            if (ret == 0) goto lab6;
            if (ret < 0) return ret;
        }
    ...
    {   int m8 = z->l - z->c; (void)m8; /* do, line 227 */
        {   int ret = r_Step_4(z); /* call Step_4, line 227 */
            if (ret == 0) goto lab7;
            if (ret < 0) return ret;
        }
    ...
    {   int c9 = z->c; /* do, line 230 */
        {   int c10 = z->c; /* and, line 230 */
            {   int ret = r_Lose_prefix(z); /* call Lose_prefix, line 230 */
                if (ret == 0) goto lab8;
                if (ret < 0) return ret;
            }
            z->c = c10;
            {   int ret = r_measure(z); /* call measure, line 230 */
                if (ret == 0) goto lab8;
                if (ret < 0) return ret;
            }
        }
    ...
    {   int m11 = z->l - z->c; (void)m11; /* do, line 232 */
        ...
        {   int ret = r_Step_1c(z); /* call Step_1c, line 232 */
            if (ret == 0) goto lab9;
            if (ret < 0) return ret;
        }
    lab9:
    ...
    {   int c12 = z->c; /* do, line 235 */
        {   int c13 = z->c; /* and, line 235 */
            {   int ret = r_Lose_infix(z); /* call Lose_infix, line 235 */
                if (ret == 0) goto lab10;
                if (ret < 0) return ret;
            }
            z->c = c13;
            {   int ret = r_measure(z); /* call measure, line 235 */
                if (ret == 0) goto lab10;
                if (ret < 0) return ret;
            }
        }
    ...
    {   int m14 = z->l - z->c; (void)m14; /* do, line 237 */
        ...
        {   int ret = r_Step_1c(z); /* call Step_1c, line 237 */
            if (ret == 0) goto lab11;
            if (ret < 0) return ret;
        }
    lab11:
    ...
    {   int m15 = z->l - z->c; (void)m15; /* do, line 240 */
        {   int ret = r_Step_7(z); /* call Step_7, line 240 */
            if (ret == 0) goto lab12;
            if (ret < 0) return ret;
        }
    ...
    lab14:
        {   int ret = r_Step_6(z); /* call Step_6, line 241 */
            if (ret == 0) goto lab13;
            if (ret < 0) return ret;
        }
    lab13:
    ...
    {   int c17 = z->c; /* do, line 243 */
        ...
        while(1) { /* repeat, line 243 */
            ...
            while(1) { /* goto, line 243 */
                int c19 = z->c;
                z->bra = z->c; /* [, line 243 */
                if (z->c == z->l || z->p[z->c] != 'Y') goto lab18; /* literal, line 243 */
                z->c++;
                z->ket = z->c; /* ], line 243 */
                z->c = c19;
                break;
            ...
            {   int ret = slice_from_s(z, 1, s_74); /* <-, line 243 */
                if (ret < 0) return ret;
            }
            continue;
        lab17:
