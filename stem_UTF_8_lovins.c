...
static int r_A(struct SN_env * z) { /* backwardmode */
    {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 21 */
        if (ret < 0) return 0;
        z->c = ret;
    }
    return 1;
...
static int r_B(struct SN_env * z) { /* backwardmode */
    {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 3); /* hop, line 22 */
        if (ret < 0) return 0;
        z->c = ret;
    }
    return 1;
...
static int r_C(struct SN_env * z) { /* backwardmode */
    {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 4); /* hop, line 23 */
        if (ret < 0) return 0;
        z->c = ret;
    }
    return 1;
...
static int r_D(struct SN_env * z) { /* backwardmode */
    {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 5); /* hop, line 24 */
        if (ret < 0) return 0;
        z->c = ret;
    }
    return 1;
...
static int r_E(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 25 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 25 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* not, line 25 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'e') goto lab0; /* literal, line 25 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
...
static int r_F(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 26 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 3); /* hop, line 26 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* not, line 26 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'e') goto lab0; /* literal, line 26 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
...
static int r_G(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 27 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 3); /* hop, line 27 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    if (z->c <= z->lb || z->p[z->c - 1] != 'f') return 0; /* literal, line 27 */
    z->c--;
    return 1;
}

static int r_H(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 28 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 28 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* or, line 28 */
        if (z->c <= z->lb || z->p[z->c - 1] != 't') goto lab1; /* literal, line 28 */
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (!(eq_s_b(z, 2, s_0))) return 0; /* literal, line 28 */
    }
lab0:
    return 1;
}

static int r_I(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 29 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 29 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* not, line 29 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'o') goto lab0; /* literal, line 29 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
    }
    {   int m3 = z->l - z->c; (void)m3; /* not, line 29 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'e') goto lab1; /* literal, line 29 */
        z->c--;
        return 0;
    lab1:
        z->c = z->l - m3;
...
static int r_J(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 30 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 30 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* not, line 30 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'a') goto lab0; /* literal, line 30 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
    }
    {   int m3 = z->l - z->c; (void)m3; /* not, line 30 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'e') goto lab1; /* literal, line 30 */
        z->c--;
        return 0;
    lab1:
        z->c = z->l - m3;
...
static int r_K(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 31 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 3); /* hop, line 31 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* or, line 31 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'l') goto lab1; /* literal, line 31 */
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'i') goto lab2; /* literal, line 31 */
        z->c--;
        goto lab0;
    lab2:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'e') return 0; /* literal, line 31 */
        z->c--;
        {   int ret = skip_utf8(z->p, z->c, z->lb, 0, -1);
            if (ret < 0) return 0;
            z->c = ret; /* next, line 31 */
        }
        if (z->c <= z->lb || z->p[z->c - 1] != 'u') return 0; /* literal, line 31 */
        z->c--;
    }
lab0:
    return 1;
...
static int r_L(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 32 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 32 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* not, line 32 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'u') goto lab0; /* literal, line 32 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
    ...
    {   int m3 = z->l - z->c; (void)m3; /* not, line 32 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'x') goto lab1; /* literal, line 32 */
        z->c--;
        return 0;
    lab1:
        z->c = z->l - m3;
    ...
    {   int m4 = z->l - z->c; (void)m4; /* not, line 32 */
        if (z->c <= z->lb || z->p[z->c - 1] != 's') goto lab2; /* literal, line 32 */
        z->c--;
        {   int m5 = z->l - z->c; (void)m5; /* not, line 32 */
            if (z->c <= z->lb || z->p[z->c - 1] != 'o') goto lab3; /* literal, line 32 */
            z->c--;
            goto lab2;
        lab3:
            z->c = z->l - m5;
...
static int r_M(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 33 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 33 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* not, line 33 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'a') goto lab0; /* literal, line 33 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
    ...
    {   int m3 = z->l - z->c; (void)m3; /* not, line 33 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'c') goto lab1; /* literal, line 33 */
        z->c--;
        return 0;
    lab1:
        z->c = z->l - m3;
    ...
    {   int m4 = z->l - z->c; (void)m4; /* not, line 33 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'e') goto lab2; /* literal, line 33 */
        z->c--;
        return 0;
    lab2:
        z->c = z->l - m4;
    }
    {   int m5 = z->l - z->c; (void)m5; /* not, line 33 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'm') goto lab3; /* literal, line 33 */
        z->c--;
        return 0;
    lab3:
        z->c = z->l - m5;
...
static int r_N(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 34 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 3); /* hop, line 34 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 34 */
        if (ret < 0) return 0;
        z->c = ret;
    }
    {   int m2 = z->l - z->c; (void)m2; /* or, line 34 */
        {   int m3 = z->l - z->c; (void)m3; /* not, line 34 */
            if (z->c <= z->lb || z->p[z->c - 1] != 's') goto lab2; /* literal, line 34 */
            z->c--;
            goto lab1;
        lab2:
            z->c = z->l - m3;
...
static int r_O(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 35 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 35 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* or, line 35 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'l') goto lab1; /* literal, line 35 */
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'i') return 0; /* literal, line 35 */
        z->c--;
    }
lab0:
    return 1;
...
static int r_P(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 36 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 36 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* not, line 36 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'c') goto lab0; /* literal, line 36 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
...
static int r_Q(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 37 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 37 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m_test2 = z->l - z->c; /* test, line 37 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 3); /* hop, line 37 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test2;
    }
    {   int m3 = z->l - z->c; (void)m3; /* not, line 37 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'l') goto lab0; /* literal, line 37 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m3;
    }
    {   int m4 = z->l - z->c; (void)m4; /* not, line 37 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'n') goto lab1; /* literal, line 37 */
        z->c--;
        return 0;
    lab1:
        z->c = z->l - m4;
...
static int r_R(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 38 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 38 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* or, line 38 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'n') goto lab1; /* literal, line 38 */
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'r') return 0; /* literal, line 38 */
        z->c--;
    }
lab0:
    return 1;
...
static int r_S(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 39 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 39 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* or, line 39 */
        if (!(eq_s_b(z, 2, s_1))) goto lab1; /* literal, line 39 */
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 't') return 0; /* literal, line 39 */
        z->c--;
        {   int m3 = z->l - z->c; (void)m3; /* not, line 39 */
            if (z->c <= z->lb || z->p[z->c - 1] != 't') goto lab2; /* literal, line 39 */
            z->c--;
            return 0;
        lab2:
            z->c = z->l - m3;
...
static int r_T(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 40 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 40 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* or, line 40 */
        if (z->c <= z->lb || z->p[z->c - 1] != 's') goto lab1; /* literal, line 40 */
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 't') return 0; /* literal, line 40 */
        z->c--;
        {   int m3 = z->l - z->c; (void)m3; /* not, line 40 */
            if (z->c <= z->lb || z->p[z->c - 1] != 'o') goto lab2; /* literal, line 40 */
            z->c--;
            return 0;
        lab2:
            z->c = z->l - m3;
...
static int r_U(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 41 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 41 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* or, line 41 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'l') goto lab1; /* literal, line 41 */
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'm') goto lab2; /* literal, line 41 */
        z->c--;
        goto lab0;
    lab2:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'n') goto lab3; /* literal, line 41 */
        z->c--;
        goto lab0;
    lab3:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'r') return 0; /* literal, line 41 */
        z->c--;
    }
lab0:
    return 1;
...
static int r_V(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 42 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 42 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    if (z->c <= z->lb || z->p[z->c - 1] != 'c') return 0; /* literal, line 42 */
    z->c--;
    return 1;
}

static int r_W(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 43 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 43 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* not, line 43 */
        if (z->c <= z->lb || z->p[z->c - 1] != 's') goto lab0; /* literal, line 43 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
    }
    {   int m3 = z->l - z->c; (void)m3; /* not, line 43 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'u') goto lab1; /* literal, line 43 */
        z->c--;
        return 0;
    lab1:
        z->c = z->l - m3;
...
static int r_X(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 44 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 44 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* or, line 44 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'l') goto lab1; /* literal, line 44 */
        z->c--;
        goto lab0;
    lab1:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'i') goto lab2; /* literal, line 44 */
        z->c--;
        goto lab0;
    lab2:
        z->c = z->l - m2;
        if (z->c <= z->lb || z->p[z->c - 1] != 'e') return 0; /* literal, line 44 */
        z->c--;
        {   int ret = skip_utf8(z->p, z->c, z->lb, 0, -1);
            if (ret < 0) return 0;
            z->c = ret; /* next, line 44 */
        }
        if (z->c <= z->lb || z->p[z->c - 1] != 'u') return 0; /* literal, line 44 */
        z->c--;
    }
lab0:
    return 1;
...
static int r_Y(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 45 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 45 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    if (!(eq_s_b(z, 2, s_2))) return 0; /* literal, line 45 */
    return 1;
}

static int r_Z(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 46 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 46 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    {   int m2 = z->l - z->c; (void)m2; /* not, line 46 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'f') goto lab0; /* literal, line 46 */
        z->c--;
        return 0;
    lab0:
        z->c = z->l - m2;
...
static int r_AA(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 47 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 47 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1839440 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0; /* among, line 47 */
    if (!(find_among_b(z, a_0, 9))) return 0;
    return 1;
}

static int r_BB(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 49 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 3); /* hop, line 49 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* not, line 49 */
        if (!(eq_s_b(z, 3, s_3))) goto lab0; /* literal, line 49 */
        return 0;
    lab0:
        z->c = z->l - m2;
    }
    {   int m3 = z->l - z->c; (void)m3; /* not, line 49 */
        if (!(eq_s_b(z, 4, s_4))) goto lab1; /* literal, line 49 */
        return 0;
    lab1:
        z->c = z->l - m3;
    }
...
static int r_CC(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 50 */
        {   int ret = skip_utf8(z->p, z->c, z->lb, z->l, - 2); /* hop, line 50 */
            if (ret < 0) return 0;
            z->c = ret;
        }
        z->c = z->l - m_test1;
    }
    if (z->c <= z->lb || z->p[z->c - 1] != 'l') return 0; /* literal, line 50 */
    z->c--;
    return 1;
}

static int r_endings(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 56 */
...
static int r_undouble(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 152 */
        if (z->c - 1 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1929364 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0; /* substring, line 152 */
...
static int r_respell(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->ket = z->c; /* [, line 160 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((89919504 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0; /* substring, line 160 */
    ...
    switch (among_var) { /* among, line 160 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 3, s_5); /* <-, line 161 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(z, 2, s_6); /* <-, line 162 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(z, 2, s_7); /* <-, line 163 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(z, 2, s_8); /* <-, line 164 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(z, 2, s_9); /* <-, line 165 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(z, 5, s_10); /* <-, line 166 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(z, 5, s_11); /* <-, line 167 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(z, 4, s_12); /* <-, line 168 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int m1 = z->l - z->c; (void)m1; /* not, line 169 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'a') goto lab0; /* literal, line 169 */
                z->c--;
                return 0;
            lab0:
                z->c = z->l - m1;
            ...
            {   int m2 = z->l - z->c; (void)m2; /* not, line 169 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'i') goto lab1; /* literal, line 169 */
                z->c--;
                return 0;
            lab1:
                z->c = z->l - m2;
            ...
            {   int m3 = z->l - z->c; (void)m3; /* not, line 169 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'o') goto lab2; /* literal, line 169 */
                z->c--;
                return 0;
            lab2:
                z->c = z->l - m3;
            }
            {   int ret = slice_from_s(z, 1, s_13); /* <-, line 169 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = slice_from_s(z, 3, s_14); /* <-, line 170 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(z, 3, s_15); /* <-, line 171 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret = slice_from_s(z, 3, s_16); /* <-, line 172 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret = slice_from_s(z, 3, s_17); /* <-, line 173 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret = slice_from_s(z, 2, s_18); /* <-, line 174 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret = slice_from_s(z, 2, s_19); /* <-, line 175 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
            {   int ret = slice_from_s(z, 2, s_20); /* <-, line 176 */
                if (ret < 0) return ret;
            }
            break;
        case 17:
            {   int ret = slice_from_s(z, 3, s_21); /* <-, line 177 */
                if (ret < 0) return ret;
            }
            break;
        case 18:
            {   int ret = slice_from_s(z, 3, s_22); /* <-, line 178 */
                if (ret < 0) return ret;
            }
            break;
        case 19:
            {   int ret = slice_from_s(z, 3, s_23); /* <-, line 179 */
                if (ret < 0) return ret;
            }
            break;
        case 20:
            {   int ret = slice_from_s(z, 3, s_24); /* <-, line 180 */
                if (ret < 0) return ret;
            }
            break;
        case 21:
            {   int ret = slice_from_s(z, 3, s_25); /* <-, line 181 */
                if (ret < 0) return ret;
            }
            break;
        case 22:
            {   int ret = slice_from_s(z, 4, s_26); /* <-, line 182 */
                if (ret < 0) return ret;
            }
            break;
        case 23:
            {   int ret = slice_from_s(z, 4, s_27); /* <-, line 183 */
                if (ret < 0) return ret;
            }
            break;
        case 24:
            {   int m4 = z->l - z->c; (void)m4; /* not, line 184 */
                if (z->c <= z->lb || z->p[z->c - 1] != 's') goto lab3; /* literal, line 184 */
                z->c--;
                return 0;
            lab3:
                z->c = z->l - m4;
            }
            {   int ret = slice_from_s(z, 3, s_28); /* <-, line 184 */
                if (ret < 0) return ret;
            }
            break;
        case 25:
            {   int ret = slice_from_s(z, 3, s_29); /* <-, line 185 */
                if (ret < 0) return ret;
            }
            break;
        case 26:
            {   int ret = slice_from_s(z, 3, s_30); /* <-, line 186 */
                if (ret < 0) return ret;
            }
            break;
        case 27:
            {   int ret = slice_from_s(z, 3, s_31); /* <-, line 187 */
                if (ret < 0) return ret;
            }
            break;
        case 28:
            {   int m5 = z->l - z->c; (void)m5; /* not, line 188 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'p') goto lab4; /* literal, line 188 */
                z->c--;
                return 0;
            lab4:
                z->c = z->l - m5;
            ...
            {   int m6 = z->l - z->c; (void)m6; /* not, line 188 */
                if (z->c <= z->lb || z->p[z->c - 1] != 't') goto lab5; /* literal, line 188 */
                z->c--;
                return 0;
            lab5:
                z->c = z->l - m6;
            }
            {   int ret = slice_from_s(z, 3, s_32); /* <-, line 188 */
                if (ret < 0) return ret;
            }
            break;
        case 29:
            {   int ret = slice_from_s(z, 3, s_33); /* <-, line 189 */
                if (ret < 0) return ret;
            }
            break;
        case 30:
            {   int m7 = z->l - z->c; (void)m7; /* not, line 190 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'm') goto lab6; /* literal, line 190 */
                z->c--;
                return 0;
            lab6:
                z->c = z->l - m7;
            }
            {   int ret = slice_from_s(z, 3, s_34); /* <-, line 190 */
                if (ret < 0) return ret;
            }
            break;
        case 31:
            {   int ret = slice_from_s(z, 3, s_35); /* <-, line 192 */
                if (ret < 0) return ret;
            }
            break;
        case 32:
            {   int m8 = z->l - z->c; (void)m8; /* not, line 193 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'n') goto lab7; /* literal, line 193 */
                z->c--;
                return 0;
            lab7:
                z->c = z->l - m8;
            }
            {   int ret = slice_from_s(z, 2, s_36); /* <-, line 193 */
                if (ret < 0) return ret;
            }
            break;
        case 33:
            {   int ret = slice_from_s(z, 2, s_37); /* <-, line 194 */
                if (ret < 0) return ret;
            }
            break;
        case 34:
            {   int ret = slice_from_s(z, 2, s_38); /* <-, line 195 */
                if (ret < 0) return ret;
            }
            break;
    }
...
extern int lovins_UTF_8_stem(struct SN_env * z) { /* forwardmode */
    z->lb = z->c; z->c = z->l; /* backwards, line 202 */

    {   int m1 = z->l - z->c; (void)m1; /* do, line 203 */
        {   int ret = r_endings(z); /* call endings, line 203 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    {   int m2 = z->l - z->c; (void)m2; /* do, line 204 */
        {   int ret = r_undouble(z); /* call undouble, line 204 */
            if (ret == 0) goto lab1;
            if (ret < 0) return ret;
        }
    lab1:
    ...
    {   int m3 = z->l - z->c; (void)m3; /* do, line 205 */
        {   int ret = r_respell(z); /* call respell, line 205 */
            if (ret == 0) goto lab2;
            if (ret < 0) return ret;
        }
    lab2:
