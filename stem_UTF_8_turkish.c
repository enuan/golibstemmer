...
static int r_mark_suffix_with_optional_n_consonant(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c; (void)m1; /* or, line 134 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'n') goto lab1; /* literal, line 133 */
        z->c--;
    ...
    lab1:
        z->c = z->l - m1;
        {   int m3 = z->l - z->c; (void)m3; /* not, line 135 */
            {   int m_test4 = z->l - z->c; /* test, line 135 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'n') goto lab2; /* literal, line 135 */
                z->c--;
                z->c = z->l - m_test4;
            }
            return 0;
        ...
        {   int m_test5 = z->l - z->c; /* test, line 135 */
...
static int r_mark_suffix_with_optional_s_consonant(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c; (void)m1; /* or, line 145 */
        if (z->c <= z->lb || z->p[z->c - 1] != 's') goto lab1; /* literal, line 144 */
        z->c--;
        {   int m_test2 = z->l - z->c; /* test, line 144 */
    ...
    lab1:
        z->c = z->l - m1;
        {   int m3 = z->l - z->c; (void)m3; /* not, line 146 */
            {   int m_test4 = z->l - z->c; /* test, line 146 */
                if (z->c <= z->lb || z->p[z->c - 1] != 's') goto lab2; /* literal, line 146 */
                z->c--;
                z->c = z->l - m_test4;
            }
            return 0;
        ...
        {   int m_test5 = z->l - z->c; /* test, line 146 */
            {   int ret = skip_utf8(z->p, z->c, z->lb, 0, -1);
                if (ret < 0) return 0;
...
static int r_mark_suffix_with_optional_y_consonant(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c; (void)m1; /* or, line 155 */
        if (z->c <= z->lb || z->p[z->c - 1] != 'y') goto lab1; /* literal, line 154 */
        z->c--;
        {   int m_test2 = z->l - z->c; /* test, line 154 */
    ...
    lab1:
        z->c = z->l - m1;
        {   int m3 = z->l - z->c; (void)m3; /* not, line 156 */
            {   int m_test4 = z->l - z->c; /* test, line 156 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'y') goto lab2; /* literal, line 156 */
                z->c--;
                z->c = z->l - m_test4;
            }
            return 0;
        ...
        {   int m_test5 = z->l - z->c; /* test, line 156 */
            {   int ret = skip_utf8(z->p, z->c, z->lb, 0, -1);
                if (ret < 0) return 0;
...
static int r_mark_suffix_with_optional_U_vowel(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c; (void)m1; /* or, line 161 */
        ...
        {   int m_test2 = z->l - z->c; /* test, line 160 */
    ...
    lab1:
        z->c = z->l - m1;
        {   int m3 = z->l - z->c; (void)m3; /* not, line 162 */
            {   int m_test4 = z->l - z->c; /* test, line 162 */
        ...
        {   int m_test5 = z->l - z->c; /* test, line 162 */
            {   int ret = skip_utf8(z->p, z->c, z->lb, 0, -1);
                if (ret < 0) return 0;
...
static int r_mark_ki(struct SN_env * z) { /* backwardmode */
    if (!(eq_s_b(z, 2, s_3))) return 0; /* literal, line 237 */
    return 1;
}
...
static int r_mark_yken(struct SN_env * z) { /* backwardmode */
    if (!(eq_s_b(z, 3, s_4))) return 0; /* literal, line 308 */
...
static int r_stem_nominal_verb_suffixes(struct SN_env * z) { /* backwardmode */
    ...
    lab6:
        ...
        {   int m4 = z->l - z->c; (void)m4; /* try, line 319 */
            z->ket = z->c; /* [, line 319 */
            {   int m5 = z->l - z->c; (void)m5; /* or, line 319 */
    ...
    lab13:
        ...
        {   int m6 = z->l - z->c; (void)m6; /* or, line 323 */
    ...
    lab19:
        z->c = z->l - m1;
        {   int m7 = z->l - z->c; (void)m7; /* or, line 325 */
    ...
    lab23:
        ...
        {   int m8 = z->l - z->c; (void)m8; /* try, line 325 */
            z->ket = z->c; /* [, line 325 */
    ...
    lab22:
        ...
        {   int m9 = z->l - z->c; (void)m9; /* try, line 327 */
            z->ket = z->c; /* [, line 327 */
            {   int m10 = z->l - z->c; (void)m10; /* or, line 327 */
...
static int r_stem_suffix_chain_before_ki(struct SN_env * z) { /* backwardmode */
    ...
    {   int m1 = z->l - z->c; (void)m1; /* or, line 342 */
        ...
        {   int m2 = z->l - z->c; (void)m2; /* try, line 336 */
            z->ket = z->c; /* [, line 336 */
            {   int m3 = z->l - z->c; (void)m3; /* or, line 338 */
                ...
                {   int m4 = z->l - z->c; (void)m4; /* try, line 337 */
            ...
            lab4:
                ...
                {   int m5 = z->l - z->c; (void)m5; /* try, line 339 */
                    z->ket = z->c; /* [, line 339 */
    ...
    lab1:
        ...
        {   int m6 = z->l - z->c; (void)m6; /* try, line 343 */
            z->ket = z->c; /* [, line 343 */
            {   int m7 = z->l - z->c; (void)m7; /* or, line 345 */
            ...
            lab10:
                z->c = z->l - m7;
                z->ket = z->c; /* [, line 346 */
                {   int m8 = z->l - z->c; (void)m8; /* or, line 346 */
            ...
            lab12:
                ...
                {   int m9 = z->l - z->c; (void)m9; /* try, line 346 */
                    z->ket = z->c; /* [, line 346 */
    ...
    lab7:
        ...
        {   int m10 = z->l - z->c; (void)m10; /* or, line 353 */
        ...
        lab16:
            ...
            {   int m11 = z->l - z->c; (void)m11; /* try, line 354 */
                z->ket = z->c; /* [, line 354 */
...
static int r_stem_noun_suffixes(struct SN_env * z) { /* backwardmode */
    {   int m1 = z->l - z->c; (void)m1; /* or, line 363 */
        ...
        {   int m2 = z->l - z->c; (void)m2; /* try, line 362 */
    ...
    lab1:
        ...
        {   int m3 = z->l - z->c; (void)m3; /* try, line 365 */
            {   int m4 = z->l - z->c; (void)m4; /* or, line 367 */
                z->ket = z->c; /* [, line 366 */
            ...
            lab6:
                z->c = z->l - m4;
                z->ket = z->c; /* [, line 368 */
                {   int m5 = z->l - z->c; (void)m5; /* or, line 368 */
            ...
            lab8:
                ...
                {   int m6 = z->l - z->c; (void)m6; /* try, line 368 */
                    z->ket = z->c; /* [, line 368 */
    ...
    lab3:
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 374 */
        {   int m7 = z->l - z->c; (void)m7; /* or, line 374 */
    ...
    lab12:
        {   int m8 = z->l - z->c; (void)m8; /* or, line 377 */
        ...
        lab15:
            ...
            {   int m9 = z->l - z->c; (void)m9; /* try, line 378 */
                z->ket = z->c; /* [, line 378 */
    ...
    lab11:
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 384 */
        {   int m10 = z->l - z->c; (void)m10; /* or, line 384 */
    ...
    lab19:
        {   int m11 = z->l - z->c; (void)m11; /* or, line 384 */
            ...
            {   int m12 = z->l - z->c; (void)m12; /* try, line 384 */
                z->ket = z->c; /* [, line 384 */
    ...
    lab18:
        ...
        {   int m13 = z->l - z->c; (void)m13; /* try, line 386 */
            z->ket = z->c; /* [, line 386 */
            {   int m14 = z->l - z->c; (void)m14; /* or, line 389 */
                ...
                {   int m15 = z->l - z->c; (void)m15; /* try, line 388 */
                    z->ket = z->c; /* [, line 388 */
            ...
            lab27:
                ...
                {   int m16 = z->l - z->c; (void)m16; /* try, line 390 */
    ...
    lab24:
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 396 */
        {   int m17 = z->l - z->c; (void)m17; /* or, line 396 */
    ...
    lab32:
        ...
        {   int m18 = z->l - z->c; (void)m18; /* try, line 397 */
            {   int m19 = z->l - z->c; (void)m19; /* or, line 399 */
                z->ket = z->c; /* [, line 398 */
            ...
            lab36:
                z->c = z->l - m19;
                z->ket = z->c; /* [, line 400 */
                {   int m20 = z->l - z->c; (void)m20; /* or, line 400 */
            ...
            lab38:
                ...
                {   int m21 = z->l - z->c; (void)m21; /* try, line 400 */
                    z->ket = z->c; /* [, line 400 */
    ...
    lab42:
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 410 */
        {   int m22 = z->l - z->c; (void)m22; /* or, line 410 */
    ...
    lab44:
        ...
        {   int m23 = z->l - z->c; (void)m23; /* try, line 410 */
            z->ket = z->c; /* [, line 410 */
            {   int m24 = z->l - z->c; (void)m24; /* or, line 410 */
                ...
                {   int m25 = z->l - z->c; (void)m25; /* try, line 410 */
                    z->ket = z->c; /* [, line 410 */
    ...
    lab43:
        z->c = z->l - m1;
        z->ket = z->c; /* [, line 412 */
        {   int m26 = z->l - z->c; (void)m26; /* or, line 412 */
    ...
    lab51:
        ...
        {   int m27 = z->l - z->c; (void)m27; /* try, line 412 */
            z->ket = z->c; /* [, line 412 */
...
static int r_post_process_last_consonants(struct SN_env * z) { /* backwardmode */
    ...
    switch (among_var) { /* among, line 416 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 1, s_5); /* <-, line 417 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(z, 2, s_6); /* <-, line 418 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(z, 1, s_7); /* <-, line 419 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(z, 1, s_8); /* <-, line 420 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_append_U_to_stems_ending_with_d_or_g(struct SN_env * z) { /* backwardmode */
    {   int m_test1 = z->l - z->c; /* test, line 431 */
        {   int m2 = z->l - z->c; (void)m2; /* or, line 431 */
            if (z->c <= z->lb || z->p[z->c - 1] != 'd') goto lab1; /* literal, line 431 */
            z->c--;
            goto lab0;
        lab1:
            z->c = z->l - m2;
            if (z->c <= z->lb || z->p[z->c - 1] != 'g') return 0; /* literal, line 431 */
            z->c--;
        }
    lab0:
        z->c = z->l - m_test1;
    }
    {   int m3 = z->l - z->c; (void)m3; /* or, line 433 */
        {   int m_test4 = z->l - z->c; /* test, line 432 */
            if (out_grouping_b_U(z, g_vowel, 97, 305, 1) < 0) goto lab3; /* goto */ /* grouping vowel, line 432 */
            {   int m5 = z->l - z->c; (void)m5; /* or, line 432 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'a') goto lab5; /* literal, line 432 */
                z->c--;
                goto lab4;
            lab5:
                z->c = z->l - m5;
                if (!(eq_s_b(z, 2, s_9))) goto lab3; /* literal, line 432 */
            }
        lab4:
            z->c = z->l - m_test4;
        }
        {   int ret;
            {   int saved_c = z->c;
                ret = insert_s(z, z->c, z->c, 2, s_10); /* <+, line 432 */
                z->c = saved_c;
            }
            if (ret < 0) return ret;
        }
    ...
    lab3:
        z->c = z->l - m3;
        {   int m_test6 = z->l - z->c; /* test, line 434 */
            if (out_grouping_b_U(z, g_vowel, 97, 305, 1) < 0) goto lab6; /* goto */ /* grouping vowel, line 434 */
            {   int m7 = z->l - z->c; (void)m7; /* or, line 434 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'e') goto lab8; /* literal, line 434 */
                z->c--;
                goto lab7;
            lab8:
                z->c = z->l - m7;
                if (z->c <= z->lb || z->p[z->c - 1] != 'i') goto lab6; /* literal, line 434 */
                z->c--;
            }
        lab7:
            z->c = z->l - m_test6;
        ...
        {   int ret;
            {   int saved_c = z->c;
                ret = insert_s(z, z->c, z->c, 1, s_11); /* <+, line 434 */
                z->c = saved_c;
            }
            if (ret < 0) return ret;
        }
    ...
    lab6:
        z->c = z->l - m3;
        {   int m_test8 = z->l - z->c; /* test, line 436 */
            if (out_grouping_b_U(z, g_vowel, 97, 305, 1) < 0) goto lab9; /* goto */ /* grouping vowel, line 436 */
            {   int m9 = z->l - z->c; (void)m9; /* or, line 436 */
                if (z->c <= z->lb || z->p[z->c - 1] != 'o') goto lab11; /* literal, line 436 */
                z->c--;
                goto lab10;
            lab11:
                z->c = z->l - m9;
                if (z->c <= z->lb || z->p[z->c - 1] != 'u') goto lab9; /* literal, line 436 */
                z->c--;
            }
        lab10:
            z->c = z->l - m_test8;
        ...
        {   int ret;
            {   int saved_c = z->c;
                ret = insert_s(z, z->c, z->c, 1, s_12); /* <+, line 436 */
                z->c = saved_c;
            }
            if (ret < 0) return ret;
        }
    ...
    lab9:
        z->c = z->l - m3;
        {   int m_test10 = z->l - z->c; /* test, line 438 */
            if (out_grouping_b_U(z, g_vowel, 97, 305, 1) < 0) return 0; /* goto */ /* grouping vowel, line 438 */
            {   int m11 = z->l - z->c; (void)m11; /* or, line 438 */
                if (!(eq_s_b(z, 2, s_13))) goto lab13; /* literal, line 438 */
                goto lab12;
            lab13:
                z->c = z->l - m11;
                if (!(eq_s_b(z, 2, s_14))) return 0; /* literal, line 438 */
            }
        lab12:
            z->c = z->l - m_test10;
        }
        {   int ret;
            {   int saved_c = z->c;
                ret = insert_s(z, z->c, z->c, 2, s_15); /* <+, line 438 */
                z->c = saved_c;
            }
            if (ret < 0) return ret;
        }
...
static int r_is_reserved_word(struct SN_env * z) { /* forwardmode */
    {   int c1 = z->c; /* or, line 451 */
        {   int c_test2 = z->c; /* test, line 450 */
            while(1) { /* gopast, line 450 */
                if (!(eq_s(z, 2, s_16))) goto lab2; /* literal, line 450 */
                break;
            lab2:
    ...
    lab1:
        z->c = c1;
        {   int c_test3 = z->c; /* test, line 452 */
            while(1) { /* gopast, line 452 */
                if (!(eq_s(z, 5, s_17))) goto lab3; /* literal, line 452 */
                break;
            lab3:
                {   int ret = skip_utf8(z->p, z->c, 0, z->l, 1);
                    if (ret < 0) return 0;
