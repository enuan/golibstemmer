    ...
    switch (among_var) { /* among, line 77 */
        ...
        case 7:
            ...
            {   int m3 = z->l - z->c; (void)m3; /* try, line 135 */
                ...
                if (!(among_var)) { z->c = z->l - m3; goto lab2; }
                z->bra = z->c; /* ], line 136 */
                switch (among_var) { /* among, line 136 */
                    case 0: { z->c = z->l - m3; goto lab2; }
                    case 1:
...
static int r_verb_suffix(struct SN_env * z) { /* backwardmode */
    int among_var;
    {   int m1 = z->l - z->c; (void)m1; /* setlimit, line 159 */
        int mlimit1;
...
extern int portuguese_ISO_8859_1_stem(struct SN_env * z) { /* forwardmode */
        ...
        {   int m4 = z->l - z->c; (void)m4; /* or, line 209 */
            ...
            lab5:
                ...
                {   int m7 = z->l - z->c; (void)m7; /* do, line 207 */
                    ...
                    z->c--;
                    z->bra = z->c; /* ], line 207 */
                    {   int m_test8 = z->l - z->c; /* test, line 207 */
    ...
    {   int m9 = z->l - z->c; (void)m9; /* do, line 211 */
