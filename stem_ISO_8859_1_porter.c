...
static int r_Step_2(struct SN_env * z) { /* backwardmode */
    ...
    switch (among_var) { /* among, line 58 */
        ...
        case 9:
            ...
            break;
        case 10:
            {   int ret = slice_from_s(z, 2, s_15); /* <-, line 71 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(z, 3, s_16); /* <-, line 72 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            ...
            break;
        case 13:
            {   int ret = slice_from_s(z, 3, s_18); /* <-, line 76 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret = slice_from_s(z, 3, s_19); /* <-, line 77 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Step_3(struct SN_env * z) { /* backwardmode */
    ...
    switch (among_var) { /* among, line 82 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 2, s_20); /* <-, line 83 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(z, 2, s_21); /* <-, line 85 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
...
extern int porter_ISO_8859_1_stem(struct SN_env * z) { /* forwardmode */
    ...
    {   int c1 = z->c; /* do, line 116 */
        ...
        z->c++;
        z->ket = z->c; /* ], line 116 */
        {   int ret = slice_from_s(z, 1, s_22); /* <-, line 116 */
            if (ret < 0) return ret;
        }
    ...
    {   int c2 = z->c; /* do, line 117 */
        while(1) { /* repeat, line 117 */
            ...
            {   int ret = slice_from_s(z, 1, s_23); /* <-, line 117 */
                if (ret < 0) return ret;
            }
    ...
    {   int c14 = z->c; /* do, line 137 */
        ...
        while(1) { /* repeat, line 137 */
            ...
            {   int ret = slice_from_s(z, 1, s_24); /* <-, line 137 */
                if (ret < 0) return ret;
            }
            continue;
        lab14:
