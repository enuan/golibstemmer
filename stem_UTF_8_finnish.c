...
static int r_case_ending(struct SN_env * z) { /* backwardmode */
    ...
    switch (among_var) { /* among, line 97 */
        ...
        case 4:
            ...
            break;
        case 5:
            if (!(eq_s_b(z, 2, s_2))) return 0; /* literal, line 102 */
            break;
        case 6:
            if (!(eq_s_b(z, 2, s_3))) return 0; /* literal, line 103 */
            break;
        case 7:
            {   int m2 = z->l - z->c; (void)m2; /* try, line 111 */
                {   int m3 = z->l - z->c; (void)m3; /* and, line 113 */
                    ...
                    lab2:
                        z->c = z->l - m4;
                        if (!(eq_s_b(z, 2, s_4))) { z->c = z->l - m2; goto lab0; } /* literal, line 112 */
                    }
                lab1:
                    z->c = z->l - m3;
    ...
    switch (among_var) { /* among, line 143 */
        ...
        case 1:
            {   int m2 = z->l - z->c; (void)m2; /* not, line 146 */
                if (!(eq_s_b(z, 2, s_5))) goto lab0; /* literal, line 146 */
                return 0;
            lab0:
                z->c = z->l - m2;
            }
...
static int r_t_plural(struct SN_env * z) { /* backwardmode */
    ...
    {   int m1 = z->l - z->c; (void)m1; /* setlimit, line 161 */
        ...
        {   int m_test2 = z->l - z->c; /* test, line 162 */
            if (in_grouping_b_U(z, g_V1, 97, 246, 0)) { z->lb = mlimit1; return 0; } /* grouping V1, line 162 */
            z->c = z->l - m_test2;
        }
    ...
    switch (among_var) { /* among, line 166 */
        ...
        case 1:
            {   int m4 = z->l - z->c; (void)m4; /* not, line 167 */
                if (!(eq_s_b(z, 2, s_6))) goto lab0; /* literal, line 167 */
                return 0;
            lab0:
                z->c = z->l - m4;
            }
