...
static int r_mark_regions(struct SN_env * z) { /* forwardmode */
    ...
    /* try, line 61 */
    if (!(z->I[0] < z->I[2])) goto lab0; /* $p1 < <integer expression>, line 61 */
...
static int r_R1(struct SN_env * z) { /* backwardmode */
    if (!(z->I[0] <= z->c)) return 0; /* $p1 <= <integer expression>, line 81 */
    return 1;
}

static int r_R2(struct SN_env * z) { /* backwardmode */
    if (!(z->I[1] <= z->c)) return 0; /* $p2 <= <integer expression>, line 82 */
    return 1;
}
        ...
        switch (among_var) { /* among, line 86 */
            ...
            case 2:
                ...
                {   int m2 = z->l - z->c; (void)m2; /* try, line 92 */
                    ...
                    z->c--;
                    z->bra = z->c; /* ], line 92 */
                    if (!(eq_s_b(z, 3, s_11))) { z->c = z->l - m2; goto lab1; } /* literal, line 92 */
        ...
        switch (among_var) { /* among, line 110 */
            ...
            case 1:
                ...
                {   int m5 = z->l - z->c; (void)m5; /* try, line 113 */
                    z->ket = z->c; /* [, line 113 */
                    if (!(eq_s_b(z, 2, s_12))) { z->c = z->l - m5; goto lab4; } /* literal, line 113 */
                    z->bra = z->c; /* ], line 113 */
            ...
            case 3:
                ...
                {   int m8 = z->l - z->c; (void)m8; /* try, line 120 */
                    ...
                    {   int m9 = z->l - z->c; (void)m9; /* or, line 121 */
                        if (!(eq_s_b(z, 2, s_13))) goto lab9; /* literal, line 121 */
                        goto lab8;
                    lab9:
                        z->c = z->l - m9;
                        if (!(eq_s_b(z, 2, s_14))) { z->c = z->l - m8; goto lab7; } /* literal, line 121 */
                    }
                lab8:
                    z->bra = z->c; /* ], line 121 */
            ...
            case 4:
                ...
                {   int m10 = z->l - z->c; (void)m10; /* try, line 126 */
                    ...
                    if (!(among_var)) { z->c = z->l - m10; goto lab10; }
                    z->bra = z->c; /* ], line 127 */
