    ...
    while(1) { /* repeat, line 60 */
        ...
        switch (among_var) { /* among, line 62 */
            ...
            case 4:
                ...
                break;
            case 5:
                {   int ret = slice_from_s(z, 1, s_8); /* <-, line 67 */
                    if (ret < 0) return ret;
                }
                break;
            case 6:
        ...
        switch (among_var) { /* among, line 80 */
            ...
            case 2:
                ...
                {   int m2 = z->l - z->c; (void)m2; /* try, line 86 */
                    ...
                    z->c--;
                    z->bra = z->c; /* ], line 86 */
                    if (!(eq_s_b(z, 3, s_9))) { z->c = z->l - m2; goto lab1; } /* literal, line 86 */
        ...
        switch (among_var) { /* among, line 104 */
            ...
            case 1:
                ...
                {   int m5 = z->l - z->c; (void)m5; /* try, line 107 */
                    z->ket = z->c; /* [, line 107 */
                    if (!(eq_s_b(z, 2, s_10))) { z->c = z->l - m5; goto lab4; } /* literal, line 107 */
                    z->bra = z->c; /* ], line 107 */
            ...
            case 3:
                ...
                {   int m8 = z->l - z->c; (void)m8; /* try, line 114 */
                    ...
                    {   int m9 = z->l - z->c; (void)m9; /* or, line 115 */
                        if (!(eq_s_b(z, 2, s_11))) goto lab9; /* literal, line 115 */
                        goto lab8;
                    lab9:
                        z->c = z->l - m9;
                        if (!(eq_s_b(z, 2, s_12))) { z->c = z->l - m8; goto lab7; } /* literal, line 115 */
                    }
                lab8:
                    z->bra = z->c; /* ], line 115 */
